        ...
        {step === 2 && (
          <div className="space-y-6">
            <div className="flex items-start justify-between">
              ...
              >
                {formData.isGuerande ? '📍 Guérande' : '📍 Brest'}
              </button>
            </div>
        ...
        <div className="flex justify-between mt-8 pt-6 border-t">
          ...
          {step < 3 ? (
            ...
            <button
              ...
              className="ml-auto px-8 py-3 text-white bg-primary-600 rounded-lg hover:bg-primary-700 transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
            >
