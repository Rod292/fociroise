...
export const metadata: Metadata = {
  title: 'Module 4',
  description: 'Module 4 de la formation FOC Iroise : Cas complexes et implantologie',
}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg prose-blue max-w-none">
            <p className="text-xl text-gray-700 leading-relaxed mb-8">
              Cas complexes et implantologie
            </p>

            <h2>Objectifs du module</h2>
            <p>
              Ce module avancé traite des cas complexes et de l'implantologie sous l'angle occlusal.
            ...
            <p>
              ...
              <strong>Prérequis :</strong> Modules 1, 2 et 3 recommandés
            </p>
          </div>
