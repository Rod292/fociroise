...
export const metadata: Metadata = {
  title: 'Module 2',
  description: 'Module 2 de la formation FOC Iroise : Occlusion et pathologies, dysfonctions et parodontie',
}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg prose-blue max-w-none">
            <p className="text-xl text-gray-700 leading-relaxed mb-8">
              Occlusion et pathologies : dysfonctions et parodontie
            </p>

            <h2>Objectifs du module</h2>
            <p>
              Ce module aborde les interactions entre occlusion et pathologies parodontales,
              ainsi que la gestion des dysfonctions. [À personnaliser avec le contenu détaillé]
            </p>
            ...
            <p>
              ...
              <strong>Prérequis :</strong> Module 1 recommandé
            </p>
          </div>
