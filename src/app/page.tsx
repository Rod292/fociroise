          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 mb-12">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-xl sm:text-2xl lg:text-3xl text-gray-600 font-light leading-relaxed mb-4">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <Link
                  href="/formateurs"
                  className="inline-flex items-center gap-2 px-6 py-3 text-lg font-semibold text-white bg-primary-600 rounded-lg hover:bg-primary-700 transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                >
